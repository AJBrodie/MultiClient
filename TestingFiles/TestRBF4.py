...
meshFine.dataLst[0].name = 'DataPlot'
...
meshCoarse.dataLst[3].name = 'PercError'
meshCoarse.dataLst[3].values = numpy.zeros((meshCoarse.numNodes,1))
...
## ---------- CALCULATE % DIFFERENCE BETWEEN PLOTTED AND INTERP ------------ ##
meshCoarse.dataLst[3].values = abs(numpy.divide(meshCoarse.dataLst[2].values,meshCoarse.dataLst[1].values))*100
